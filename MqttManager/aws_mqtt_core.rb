...
module MqttCore
  class MqttCore
    ...
    def initialize(*args)
      @client = create_shared_client(*args)
    ...
    def create_shared_client(*args)
      @client = MqttShareLib::SharedClient.new(*args)
    end
    ...
    def subscribe(topic, qos=0, &callback)
      if topic.nil? 
